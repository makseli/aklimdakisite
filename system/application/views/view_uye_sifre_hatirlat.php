...
<meta name="description" content="AklimdakiSite.com da üyelik şifresi hatırlatma için kullanılır" />
<meta name="keywords" content="site kaydet, favorisite, sık kullanılan site kaydet, delicious, üye şifre hatırlatma" />
	...
	?>	
		<center style="color:#343434; font:normal 20px Calibri, Verdna;">
				...
				<a href="/" target="_parent" style="text-decoration:none; color:#33c6d3; padding:5px; background-color:#343434; font:normal 19px Calibri, Verdana;">
					Yeni şifreniz ePosta adresinize gönderilmiştir. Ana sayfaya gitmek için tıklayınız ! 
				</a>
				<br/><br/><br/><br/>
				AklimdakiSite.com u kullandığınız için teşekkür ederiz <b><?PHP echo $Mesaj; ?></b>
		</center>
	<?PHP
}
else
...
<center>
	...
	<strong> AklimdakiSite.com </strong>  Şifre Hatırlatma! <!-- <br/> Site Eklemek için Üye olun ve giriş yapın ! -->
	</div>
	...
	<div style="float:left; width:100%; text-align:center;">
		...
		?>
				...
				<tr><td color="2" align="left" style="color:#343434; font:normal 11px Arial;">
					<br/>
					<a href="http://aklimdakisite.com/Uye/Giris" title="Şifrnizi Unuttuysanız Tıklayın !" class="SiteKaydetmeSistemLinkleri"> üye girişi</a>  
					 |  

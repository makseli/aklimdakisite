...
class CI_Email {
	...
	var	$useragent		= "AklimdakiSite.com";
	var	$mailpath		= "/usr/sbin/sendmail";	// Sendmail path
	var	$protocol		= "smtp";	// mail/sendmail/smtp
	var	$smtp_host		= "mail.aklimdakisite.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "cevapsiz@aklimdakisite.com";		// SMTP Username
	var	$smtp_pass		= "netmusti";		// SMTP Password
	...
	var	$_base_charsets	= array('us-ascii', 'iso-8859-9');	// 7-bit charsets (excluding language suffix)
